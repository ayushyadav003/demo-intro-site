...
export default function () {
     return (
          <div className='tc mt6'>
               ...
               <img className='ph3' src={video} height='50px' width='100px'/></a></div>
               
               <div className='container'>Clothings
               <a href='https://www.sidemenclothing.com/'>
               <img className='ph3' src={tshirt} height='50px' width='100px'/></a></div>
              
               <div className='container'>
               Memes<a href='https://www.instagram.com/_moresidemen_/?hl=en'>
               <img className='ph3' src={lol} height='50px' width='100px'/></a></div>
               
               <div className='container'>
               Gaming<a href=''>
               <img className='ph3' src={gaming} height='50px' width='100px'/></a></div>
          </div>
     )
}
